...
@section('content')
    ...
    <div class="m-portlet m-portlet--mobile">
        <div class="m-portlet__body">
                <h4 class="m-subheader__title m-subheader__title--separator">{{ trans('admin.par_category_acount') }}</h4>
            <hr>
            <!--begin: Search Form -->
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-xl-4 order-1 order-xl-2 m--align-right">
                        <button type="button" class="btn btn-primary m-btn m-btn--custom m-btn--icon m-btn--air m-btn--pill" data-toggle="modal" data-target="#m_modal_1">
                            ...
                            <span>{{ trans('admin.add_sub_category') }}</span>
            ...
            <table class="table table-striped table-bordered table-hover table-checkable" id="sub-category_table">
                <thead>
                <tr>
    ...
    @include('admin.sub-category.add');
@endsection

@push('scripts')

    <script src="/assets/odai/sub-category.js" type="text/javascript"></script>
