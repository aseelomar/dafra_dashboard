...
@section('content')
    ...
    <div class="m-portlet m-portlet--bordered m-portlet--unair">
        <form class="m-portlet__body" action="{{route('admin.backend_settings.store')}}" id="add-setting"method="POST">
            @csrf
                    ...
                    <div class=" m-portlet--bordered m-portlet--unair">
                        ...
                        <div class="m-portlet__body ">
                            <div class="form-group m-form__group row col-md-10 offset-md-1">
                                ...
                                <div class="col-10">
                                    <input class="form-control m-input " placeholder="{{ trans('admin.setting-name') }}" type="text" value="" name="key" id="example-text-input">
                                </div>
                            </div>
                            <div class="form-group m-form__group row col-md-10 offset-md-1">
                                <label for="example-text-input"  class="col-2 col-form-label  ">{{ trans('admin.setting-value') }}</label>
                                <div class="col-10">
                                    <input class="form-control m-input " placeholder="{{ trans('admin.setting-value') }}" type="text" value="" name="value" id="example-text-input">
                                </div>
                            </div>
                        </div>
