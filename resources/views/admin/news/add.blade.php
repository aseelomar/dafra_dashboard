        ...
        <div class="d-flex align-items-center">
            <div class="mr-auto">
                ...
                <ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
                    ...
                    <li class="m-nav__item">
                        <a href="" class="m-nav__link">
                            <span class="m-nav__link-text"> {{ trans('admin.new_news') }}</span>
                        </a>
                    </li>
                </ul>
            </div>
            <div>
                    <div class=" order-j1 order-xl-2 m--align-right">
                        <button type="submit" class="btn m-btn--pill btn-success save" id="publish-news">
                            <span>
                                <i class="far fa-newspaper"></i>
                                <span>{{trans('admin.publish-new-news')}}</span>
                            </span>
                        </button>
                        <button type="submit" class="btn m-btn--pill btn-success save" id="add-news">
                            <span>
                                <i class="far fa-newspaper"></i>
                                <span>{{trans('admin.add-new-news')}}</span>
                            </span>
                        </button>
...
@section('content')
    ...
    <div class="m-portlet m-portlet--bordered m-portlet--unair">
        <form class="m-portlet__body" action="{{route('admin.news.store', 0)}}" id="add-new-nwes" method="POST" enctype="multipart/form-data">
            @csrf
                    ...
                    <div class="m-portlet m-portlet--bordered m-portlet--unair">
                        ...
                        <div class="m-portlet__body">
                            <div class="form-group m-form__group row">
                                ...
                                <div class="col-10">
                                    <input class="form-control m-input " placeholder="{{ trans('admin.news_title') }}" type="text" value="{{ old('title') }}" name="title" id="example-text-input">
                                    @if ($errors->has('title'))
                    ...
                    <div class="m-portlet m-portlet--bordered m-portlet--bordered-semi m-portlet--rounded">
                        ...
                        <div class="m-portlet__body">
                            <select class="form-control m-select2" id="m_select2_5" name="category_id">
                                <option value="2" selected="selected"> {{ trans('admin.Choose-category') }}</option>
