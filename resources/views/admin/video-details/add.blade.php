        ...
        <div class="d-flex align-items-center">
            ...
            <div>
                <div class=" order-j1 order-xl-2 m--align-right">
                    <button type="submit" class="btn m-btn--pill btn-success" id="add-video-details">
                            <span>
...
@section('content')
    ...
    <div class="m-portlet m-portlet--bordered m-portlet--unair">
        <form class="m-portlet__body" action="{{route('admin.video_details.store')}}" id="add-new-video_details" method="POST" enctype="multipart/form-data">
            @csrf
                    ...
                    <div class="m-portlet m-portlet--bordered m-portlet--unair">
                        ...
                        <div class="m-portlet__body">
                            <div class="form-group m-form__group row">
                                ...
                                <div class="col-10">
                                    <input class="form-control m-input " placeholder="{{ trans('admin.name') }}" type="text" value="{{ old('name') }}" name="name" id="example-text-input">
                                </div>
                            </div>
                            <div class="form-group m-form__group row has-success">
                                ...
                                <div class="col-lg-4 col-6">
                                    <div class="input-group timepicker">
                                        <input class="form-control m-input" name="time" id="m_timepicker_1_validate" readonly="" placeholder="Select time" type="text">
                                ...
                                <div class="col-10">
                                    <div class="m-radio-inline">
                                        <label class="m-checkbox m-checkbox">
                                            <input name="at_home"  value="1" type="checkbox">  عرض في السلايدر الرئيسي
                                            <span></span>
                                        </label>
                                    </div>
                                </div>
