        ...
        <div class="d-flex align-items-center">
            <div class="mr-auto">
                ...
                <ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
                    ...
                    <li class="m-nav__item">
                        <a href="#" class="m-nav__link">
                            <span class="m-nav__link-text"> {{ trans('admin.new_user') }}</span>
                        </a>
                    </li>
                </ul>
            </div>
...
@section('content')
    ...
    <div class="m-portlet">
        ...
        <!--begin::Form-->
        <form method="post" action="{{ route('admin.users.store') }}" id="store_user" enctype="multipart/form-data" class="m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed">
            @csrf
            <div class="m-portlet__body">
                <div class="form-group m-form__group row">
                    <div class="col-lg-6">
                        <label>{{ trans('admin.user_name') }}:</label>
                        <input type="text" name="name" class="form-control m-input" placeholder="{{ trans('admin.user_name') }}">
                    </div>
                    <div class="col-lg-6">
                        <label class="">{{ trans('admin.email') }}:</label>
                        <input type="email" name="email" class="form-control m-input" placeholder="{{ trans('admin.email') }}">
                    </div>
                </div>
                <div class="form-group m-form__group row">
                    <div class="col-lg-6">
                        <label>{{ trans('admin.password') }}:</label>
                        <input type="text" name="password" class="form-control m-input" placeholder="{{ trans('admin.password') }}">
                    </div>
                        ...
                        <div class="m-radio-inline">
                            @foreach($roles as $role)
                                <label class="m-radio m-radio--solid">
                                    <input type="radio" name="role" value="{{ $role->id }}"> {{ $role->description }}
                                    <span></span>
                                </label>
                            @endforeach
                        </div>
                ...
                <div class="form-group m-form__group row">
                    ...
                    <div class="col-lg-6">
                        <img width="150" height="150" src="/assets/app/media/img/users/user4.jpg" alt="" class="img img-responsive rounded-circle">
                    </div>
                ...
                <div class="m-form__actions m-form__actions--solid">
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <a href="{{ route('admin.users.all') }}" class="btn btn-secondary">{{ trans('admin.cancel') }}</a>
                        </div>
                    </div>
                </div>
            </div>
