...
@section('sub-header')
    <div class="m-subheader ">
        <div class="d-flex align-items-center">
            <div class="mr-auto">
                <h3 class="m-subheader__title m-subheader__title--separator">{{ trans('admin.update-page') }}</h3>
            </div>
...
@section('content')
    ...
    <div class="m-portlet m-portlet--bordered m-portlet--unair">
        <form class="m-portlet__body" action="{{route('admin.page.update',$page->id)}}" id="update-page"method="POST">
            @csrf
                    ...
                    <div class=" m-portlet--bordered m-portlet--unair">
                        ...
                        <div class="m-portlet__body ">
                            <div class="form-group m-form__group row col-md-10 offset-md-1">
                                ...
                                <div class="col-10">
                                    <input class="form-control m-input " placeholder="{{ trans('admin.page-name') }}" type="text" value="{{$page->name}}" name="name" id="example-text-input">
                                </div>
                            </div>
                            <div class="form-group m-form__group row col-md-10 offset-md-1">
                                <label for="example-text-input"  class="col-2 col-form-label  ">{{ trans('admin.page_content') }}</label>
                                <div class="col-10">
                                    <textarea name="content" style="height: 400px" class="summernote" id="m_summernote_1">{{$page->content}}</textarea>
                                </div>
                            </div>
